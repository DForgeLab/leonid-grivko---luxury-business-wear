            ...
            <div className="container mx-auto px-4 sm:px-6">
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    <div className="lg:w-1/2">
                        ...
                        <p className="text-lg sm:text-xl font-semibold text-textSecondaryOnLight mb-8 stagger-child font-sans">
                            Получите профессиональные советы от эксперта, который работает с топ-менеджерами
                        </p>
                        <p className="text-textSecondaryOnLight text-base sm:text-lg mb-8 leading-relaxed stagger-child">
                            Наш стилист проведет 45-минутную консультацию, где:
                        </p>
                        <ul className="list-none space-y-4 text-textSecondaryOnLight text-base sm:text-lg mb-10 pl-2">
