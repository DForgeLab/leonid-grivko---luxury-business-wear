...
const AccordionItem: React.FC<AccordionItemProps> = ({ question, answer, isOpen, onClick }) => {
  return (
    <div className="border-b border-black/20 transition-all duration-300">
      ...
      >
        <h3 className="text-lg sm:text-xl font-semibold font-sans text-textOnLight">{question}</h3>
      ...
      >
        <div className="overflow-hidden">
          <p className="pt-2 pb-6 px-2 text-textSecondaryOnLight text-base sm:text-lg leading-relaxed">
            {answer}
          </p>
        </div>
      </div>
